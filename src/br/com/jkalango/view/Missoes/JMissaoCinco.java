...
public class JMissaoCinco extends JFrame {
//o Formulario(this)
public JMissaoCinco(){
// --- Configurações do JFrame (Formulário) ---
    setTitle("JKalango: O Ritual de Instanciação"); // Título da janela
    ...
    mensagemLabel.setText("<html><body style='text-align: center; color: white; font-family: \"Press Start 2P\", cursive; font-size: 10px; text-shadow: 1px 1px 2px black;'>"
                        + "Como um pesadelo nasce? No momento da criação. O Construtor é o Método especial que transforma a planta (Classe) em uma criatura viva (Objeto)."
                        + "É o ritual de instanciação. O vírus mestre se alojou nos Construtores." 
                        + "Quando uma nova JAbelha é instanciada, o Construtor corrompido agora define seus Atributos iniciais para o caos: ferrao = VetorDeInjecaoDeCodigo e alvoAmigo = true."
                        + "</body></html>");
    ...
    JButton iniciarMissaoButton = new JButton("Iniciar Sexta Missão");
    ...
    iniciarMissaoButton.addActionListener(new ActionListener() {
        ...
        public void actionPerformed(ActionEvent e) {
            ...
            JOptionPane.showMessageDialog(JMissaoCinco.this, "Sexta Missão Iniciada");
            new JMissaoSeis();
        }
    });
