...
public class JMissaoNove extends JFrame {
//o Formulario(this)
public JMissaoNove(){
// --- Configurações do JFrame (Formulário) ---
    ...
    mensagemLabel.setText("<html><body style='text-align: center; color: white; font-family: \"Press Start 2P\", cursive; font-size: 10px; text-shadow: 1px 1px 2px black;'>"
                        + "Existem entidades neste purgatório que são apenas... ideias. Protocolos-fantasma." 
                        + "Uma Classe Abstrata, como EntidadeDoEsquecimento, existe apenas como um conceito." 
                        + "Você não pode instanciar um Esquecimento. Mas essa Classe Abstrata decreta uma lei: qualquer classe filha que herdar dela deve implementar o Método Abstrato causarPerdaDeDados()." 
                        + "Assim, nascem os DevoradoresDeBackup, que implementam o método destruindo arquivos, e os FragmentadoresDeInstancia, que o implementam apagando outros objetos da realidade. "
                        + "</body></html>");
    ...
    iniciarMissaoButton.addActionListener(new ActionListener() {
        ...
        public void actionPerformed(ActionEvent e) {
            ...
            JOptionPane.showMessageDialog(JMissaoNove.this, "Terceira Missão Iniciada");
            new JMissaoTres();
        }
    });
