...
public class JMissaoSeis extends JFrame {
//o Formulario(this)
public JMissaoSeis(){
// --- Configurações do JFrame (Formulário) ---
    ...
    mensagemLabel.setText("<html><body style='text-align: center; color: white; font-family: \"Press Start 2P\", cursive; font-size: 10px; text-shadow: 1px 1px 2px black;'>"
                        + "Observe os monstros. Eles não são um caos aleatório. Existe uma Hierarquia de Tipos, uma linhagem." 
                        + "Você vê aquele HorrorRastejante e aquele PesadeloAlado? Ambos herdam da Classe Abstrata AbominacaoDoKernel. Isso é Herança."
                        + "Eles compartilham Atributos e Métodos básicos de corrupção, mas a classe filha PesadeloAlado adiciona seu próprio e terrível método vooGlitchado()"
                        + "</body></html>");
    ...
    iniciarMissaoButton.addActionListener(new ActionListener() {
        ...
        public void actionPerformed(ActionEvent e) {
            ...
            JOptionPane.showMessageDialog(JMissaoSeis.this, "Segunda Missão Iniciada");
            new JMissaoDois();
        }
    });
