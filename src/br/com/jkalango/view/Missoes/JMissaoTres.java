...
public class JMissaoTres extends JFrame {
//o Formulario(this)
public JMissaoTres(){
// --- Configurações do JFrame (Formulário) ---
    ...
    mensagemLabel.setText("<html><body style='text-align: center; color: white; font-family: \"Press Start 2P\", cursive; font-size: 10px; text-shadow: 1px 1px 2px black;'>"
                        + "Antes da corrupção, tudo existia como um projeto perfeito em nossa biblioteca-kerne. Um Código-Fonte Primordial. "
                        + " Isso é uma Classe. Não é a criatura, mas o seu DNA digital, o texto sagrado que define a essência de tudo o que pode vir a existir."
                        + "A Classe JAbelha continha a lógica pura de voar, coletar néctar de dados e construir colmeias de luz. "
                        + "Agora, esses arquivos estão corrompidos, e as fôrmas estão criando pesadelos. "
                        + "</body></html>");
    ...
    JButton iniciarMissaoButton = new JButton("Iniciar Quarta Missão");
    ...
    iniciarMissaoButton.addActionListener(new ActionListener() {
        ...
        public void actionPerformed(ActionEvent e) {
            ...
            JOptionPane.showMessageDialog(JMissaoTres.this, "Quarta Missão Iniciada");
            new JMissaoQuatro();
        }
    });
