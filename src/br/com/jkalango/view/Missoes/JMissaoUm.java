...
public class JMissaoUm extends JFrame {
//o Formulario(this)
public JMissaoUm(){
// --- Configurações do JFrame (Formulário) ---
    ...
    JButton iniciarMissaoButton = new JButton("Iniciar Segunda Missão");
    ...
    iniciarMissaoButton.addActionListener(new ActionListener() {
        ...
        public void actionPerformed(ActionEvent e) {
            ...
            JOptionPane.showMessageDialog(JMissaoUm.this, "Segunda Missão Iniciada");
            new JMissaoDois();
        }
    });
